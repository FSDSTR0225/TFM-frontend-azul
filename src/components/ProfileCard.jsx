  ...
  <div className="profile-card">
    <div className="avatar-container">
      <img
        ...
        alt="Avatar"
      />
     {currentProfile === user && <Link to="/edit/profile" className="edit-button">
        ✏️
      </Link>}
    </div>
      {currentProfile !== user && !player.friends?.some((friend) => friend.user._id===user._id) && (
        <div className="loading-spinner">
        <button onClick={() => setModalOpen(true)} className="view-profile-button">
        Añadir a amigos
        </button>
